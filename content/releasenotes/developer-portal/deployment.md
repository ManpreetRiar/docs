...
* We have fixed issues related to [Deploy to Licensed Cloud Node](/refguide/project-menu#deploy) flow in Mendix Studio Pro.
	** We have rolled back the restriction of Mendix Cloud v3 applications using [Deploy to Licensed Cloud Node](/refguide/project-menu#deploy) flow in Mendix Studio Pro.
	...
	** We have fixed an issue where some customers were able to login with the "Demo User" to studios target. Please note that you have to unset studios target and redeploy to the affected environment. (Ticket 106312)
